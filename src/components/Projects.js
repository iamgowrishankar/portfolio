...
const Projects = () => {
  const projects = [
    {
      ...
      tech: ["PHP", "MySQL", "Doctrine ORM", "jQuery", "Vue.js", "Redis", "AWS"],
      achievements: [
  ...
  return (
    <section id="projects" className="py-20 px-4 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white">
